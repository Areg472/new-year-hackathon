        ...
        <>
            ...
            <div className="mt-10">
                ...
                <form action="https://submit-form.com/NmxCgJpJV" className="form">
                    ...
                    <input type="text" id="name" name="name" placeholder="Name" className="border-double border-4 mb-4 w-80 bg-white dark:bg-black dark:text-white"
                           required={true}/><br/>
                    <label htmlFor="email" className="">Email</label><br/>
                    <input type="email" id="email" name="email" placeholder="Email" className="border-double border-4 mb-4 w-80 bg-white dark:bg-black dark:text-white"
                           required={true}/><br/>
