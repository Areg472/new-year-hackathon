        ...
        <>
            ...
            <div>
                ...
                <form action="https://submit-form.com/NmxCgJpJV" className="form">
                    ...
                    <input type="text" id="name" name="name" placeholder="Name" className="border-double border-4 mb-4 w-96"
                           required={true}/><br/>
                    <label htmlFor="email" className="">Email</label><br/>
                    <input type="email" id="email" name="email" placeholder="Email" className="border-double border-4 mb-4 w-96"
                           required={true}/><br/>
                    ...
                    <textarea
                        ...
                        name="message"
                        placeholder="Message"
                        className="border-double border-4 max-h-52 min-h-16 mb-4 w-96"
                        required={true}
                    ></textarea><br/>
