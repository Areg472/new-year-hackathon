            ...
            <div className="flex flex-col mt-10">
                ...
                <div className="flex flex-col space-y-6 lg:flex-row items-center lg:space-y-0 justify-center lg:space-x-36">
                    <img src="https://utfs.io/f/QI8sw9xDXLhGl1gwdLs7B5oKcCzPVTIrGWxt4ZM9q6Ajigsa"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover lg:object-fit" alt="yerevan"/>
                    <img src="https://utfs.io/f/QI8sw9xDXLhG7aRQ7DGTW2ZDCGlgBULJ7VbdyN0QksOw83Pp"
                         className="w-auto h-[302px] md:h-[303px] lg:h-[302px] border-black border-double border-4 object-cover lg:object-fit" alt="tbilisi"/>
                </div>
                ...
                <div className="flex flex-col space-y-6 lg:flex-row items-center lg:space-y-0 justify-center lg:space-x-36">
                    <img src="https://utfs.io/f/QI8sw9xDXLhG7aRQ7DGTW2ZDCGlgBULJ7VbdyN0QksOw83Pp"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover lg:object-fit" alt="tbilisi"/>
                    <img src="https://utfs.io/f/QI8sw9xDXLhGVze6N2QwkRc8SgNGDZmFqpdPfsOeYAh4IT3n"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover lg:object-fit" alt="sofia"/>
                </div>
                ...
                <div className="flex flex-col space-y-6 lg:flex-row items-center lg:space-y-0 justify-center lg:space-x-36">
                    <img src="https://utfs.io/f/QI8sw9xDXLhGGFjgcf10ApdtU3j89slu1ymrYKi6hwvW5HbT"
                         className="w-auto h-[302px] md:h-[321px] lg:h-[302px] border-black border-double border-4 object-cover lg:object-fit" alt="Paris"/>
                    <img src="https://utfs.io/f/QI8sw9xDXLhGl1gwdLs7B5oKcCzPVTIrGWxt4ZM9q6Ajigsa"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover lg:object-fit" alt="Yerevan"/>
                </div>
