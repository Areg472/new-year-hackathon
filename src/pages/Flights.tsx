            ...
            <div className="flex flex-col mt-10">
                ...
                <div className="flex flex-col space-y-6 md:flex-row items-center md:space-y-0 justify-center md:space-x-36">
                    <img src="https://utfs.io/f/QI8sw9xDXLhGl1gwdLs7B5oKcCzPVTIrGWxt4ZM9q6Ajigsa"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover md:object-none" alt="yerevan"/>
                    <img src="https://utfs.io/f/QI8sw9xDXLhG7aRQ7DGTW2ZDCGlgBULJ7VbdyN0QksOw83Pp"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover md:object-none" alt="tbilisi"/>
                </div>
                ...
                <div className="flex flex-col space-y-6 md:flex-row items-center md:space-y-0 justify-center md:space-x-36">
                    ...
                    <img src="https://utfs.io/f/QI8sw9xDXLhGVze6N2QwkRc8SgNGDZmFqpdPfsOeYAh4IT3n"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover md:object-none" alt="sofia"/>
                </div>
                ...
                <div className="flex flex-col space-y-6 md:flex-row items-center md:space-y-0 justify-center md:space-x-36">
                    <img src="https://utfs.io/f/QI8sw9xDXLhGGFjgcf10ApdtU3j89slu1ymrYKi6hwvW5HbT"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover md:object-none" alt="Paris"/>
                    <img src="https://utfs.io/f/QI8sw9xDXLhGl1gwdLs7B5oKcCzPVTIrGWxt4ZM9q6Ajigsa"
                         className="w-auto h-[302px] border-black border-double border-4 object-cover md:object-none" alt="Yerevan"/>
                </div>
