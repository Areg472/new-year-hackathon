        ...
        <>
            ...
            <div className="flex flex-col mt-10">
                ...
                <motion.div initial={{opacity: 0}}
                    ...
                    <p className="mb-10">Explore the wonders of Gyumri, the 2nd largest city in Armenia! In this tour we
                        will visit a Black castle, Frunzik's home-museum and Isahakyan's home-museum, and eat in
                        Cherqezi
                        Dzor</p>
                </motion.div>
                <motion.div initial={{opacity: 0}}
                    ...
                    <div
                        ...
                        <img src="https://utfs.io/f/QI8sw9xDXLhG9MC30ooEDCW1L37JxKPFhZuloQvzV29IEAg4"
                             className="w-[201px] h-[302px] border-black border-double border-4 object-cover lg:object-fit"
                             alt="gyumri wall"/>
            ...
            <div className="flex flex-col mt-10">
                <motion.div initial={{opacity: 0}}
                            ...
                            viewport={{root: scrollRef, margin: "40px 0px 0px 0px", once: true}}>
                    <div
                        className="flex flex-col mb-6 lg:flex-row lg:-space-x-2 lg:mb-0 lg:items-start items-center lg:mr-28">
